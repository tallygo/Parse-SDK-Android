 ...
 * used by {@link com.tallygo.GcmPushHandler}.
 */
/** package */ class GcmRegistrar {
  private static final String TAG = "com.tallygo.GcmRegistrar";
  private static final String REGISTRATION_ID_EXTRA = "registration_id";
  private static final String ERROR_EXTRA = "error";

  private static final String SENDER_ID_EXTRA = Parse.COM_TALLY_GO + ".push.gcm_sender_id";
  ...
  private Task<Void> sendRegistrationRequestAsync() {
    synchronized (lock) {
      ...
      //
      //   <meta-data android:name="com.tallygo.push.gcm_sender_id"
      ...
      if (senderID == null) {
          PLog.e(TAG, "You must provide " + SENDER_ID_EXTRA + " in your AndroidManifest.xml\n" +
                  ...
                  "<meta-data\n" +
                  "    android:name=\"com.tallygo.push.gcm_sender_id\"\n" +
  ...
  private static class Request {
    private static final String RETRY_ACTION = Parse.COM_TALLY_GO + ".RetryGcmRegistration";
