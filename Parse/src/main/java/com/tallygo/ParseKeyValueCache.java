...
/** package */ class ParseKeyValueCache {
  ...
  private static final String TAG = "TGParseKeyValueCache";
  private static final String DIR_NAME = "TGParseKeyValueCache";
  ...
  /* package for tests */ static void initialize(File path) {
    if (!path.isDirectory() && !path.mkdir()) {
      throw new RuntimeException("Could not create TGParseKeyValueCache directory");
    }
    directory = path;
  }
