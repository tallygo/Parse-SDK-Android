...
/**
 *
 * DO NOT USE EXTERNALLY OF TALLYGO
 *
 * The {@code Parse} class forked for use at TallyGo
 */
public class Parse {
...
//          }
  ...
  public static void initialize(Configuration configuration) {
    if (!checkIsTallyGo(configuration)) {
      Log.e(TAG, "This version of Parse is to only be used by the TallyGo SDK");
      return;
    }
    if (isInitialized()) {
